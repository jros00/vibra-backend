"""
Django settings for vibra_backend project.
...
from super_secret import my_ip
import os
...
SECRET_KEY = 'django-insecure-ws0d$xx*id2u_dik3(r&dfsy59ac$*#j*_debc8egyqrl#2m6+'
